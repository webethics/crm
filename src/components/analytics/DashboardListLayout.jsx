               ...
               <Grid sx={{ display: 'flex', flexWrap: 'wrap' }}>
                  <Grid item xs={12} sx={{ display: 'flex', position: 'relative', alignItems: { xs: 'center', lg: 'flex-start' }, flexDirection: { xs: 'row', xl: 'column' } }}>
                     ...
                     <Box component="div" sx={{ display: 'inline-block', boxSizing: 'border-box', pr: 3, width: { xl: '100%' } }}>
                        <Typography component="div" sx={{ fontWeight: 'bold', color: item.gridBgColor ? 'common.white' : 'primary.dark', fontFamily: "'Roboto',sans-serif", fontSize: { xs: '15px', lg: '14px' } }}>{item.value}</Typography>
                        <Typography component="div" sx={{ color: item.gridBgColor ? 'common.white' : 'sidebar.label', lineHeight: 1, fontSize: { xs: '14px', lg: '13px' }, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>{item.name}</Typography>
                     </Box>
                     <Typography component="div" sx={{ position: 'absolute', top: 0, right: 0, lineHeight: 1, color: item.gridBgColor ? 'common.white' : 'sidebar.label', fontSize: { xs: '14px', lg: '13px' } }}>October</Typography>
                     <VisibilityIcon sx={{ position: 'absolute', bottom: 0, right: 0, fontSize: 16, color: item.gridBgColor ? 'common.white' : 'sidebar.label' }} />
                  </Grid>
               </Grid >
            </Paper >
         </Grid >
