   ...
   return (
      <>
         ...
         <Drawer anchor="left" open={isDrawerOpen} onClose={() => setIsDrawerOpen(false)} className={openProfile ? 'dropdown-opens' : ''}>
            <Box px={2} width={{ xs: "76px", lg: "225px", maxWidth: "100%", minWidth: { lg: "225px" } }} role="presentation" display="flex" flexWrap="wrap" flexDirection="column" sx={{ flex: 1, boxSizing: "border-box" }}>
               {/* Sidebar Logo */}
