...
const BottomMenus = () => {
   ...
   const handleTabRoute = (newRoute) => {
      console.log(newRoute);
      <Navigate to={newRoute ? newRoute : '/'} replace={true} />
   };
   return (
      <Stack sx={{ bottom: 0, position: "fixed", left: 0, right: 0, backgroundColor: "#ffffff" }}>
         <BottomNavigation value={value} onChange={handleChange} sx={{ maxWidth: '320px', width: '100%', margin: 'auto', }}>
            ...
            <BottomNavigationAction
               sx={{ px: 1, pt: 0, minWidth: '60px', mt: '-27px', backgroundColor: value == 'analytics' ? 'primary.light' : 'primary.light', height: '55px', borderRadius: '100%', lineHeight: '55px', maxWidth: '55px', minWidth: '55px', boxShadow: '0 0 0px 5px #acaeb4' }}
               value="analytics"
